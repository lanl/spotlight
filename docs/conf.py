...
#    sys.path.insert(0, site_packages_glob) #site_packages)
...
latex_documents = [
    (master_doc, 'spotlight.tex', 'spotlight Documentation',
     'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'spotlight', 'spotlight Documentation',
     [author], 1)
]
