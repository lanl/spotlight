...
We include a script in the ``tools/`` dir to demonstrate how Spotlight can be installed using Anaconda3; this script has been tested using Anaconda3 v4.7.10.
